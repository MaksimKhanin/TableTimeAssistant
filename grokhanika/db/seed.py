...
def seed_all(session) -> dict:
    ...
    cat["steam_rifle"] = Weapon(
        name="Стим-винтовка", description="Огнестрельное оружие на паровых зарядах. Стреляет разрывными капсулами с оглушительным треском. На чёрном рынке Аники стоит как недельный заработок заводского мастера.",
        damage_dice="2d8", str_requirement=6, dex_requirement=5, price=35, is_ranged=True, is_unique=True,
        effects=[_stat_eff(EffectTarget.DEXTERITY, 2, SourceType.WEAPON, ActivationSource.EQUIPPED_WEAPON, "Стим-винтовка: DEX +2")],
    )
    ...
    cat["magic_arrows"] = Item(
        name="Магические стрелы", description="Колчан зачарованных стрел. Не тупятся, летят точнее — дают +2 к физ.урону при стрельбе из лука.",
        price=8,
        effects=[_attr_eff(EffectTarget.PHYS_DAMAGE, 2, SourceType.ITEM, ActivationSource.IN_INVENTORY_RANGED, "Магические стрелы: +2 к физ.урону (только с луком)")],
    )
    cat["dex_gloves"] = Item(
    ...
    cat["city_guard"] = Creature(
        name="Городской стражник Аники", description="Рядовой стражи Аники — хорошо обучен, действует по уставу. Большинство — честные служаки. Среди них, однако, немало тайных членов Культа Бурь: распознать таких можно по серебряному значку под воротником.",
        is_sentient=True,
    ...
    cat["goblin"] = Creature(
        ...
        phys_damage_dice="1d4", strength=1, charisma=3, wisdom=4,
    )
    cat["assassin"] = Creature(
        name="Теневой убийца", description="Профессиональный наёмник из теневого мира Нижних Граней. Специализируется на устранении целей без свидетелей и следов. Работает исключительно по контракту; его цена высока — почти как у стим-пистолета на чёрном рынке.",
        is_sentient=True, is_unique=True,
        hp=14, dexterity=10, phys_defense=9, mag_defense=4, mental_defense=8,
        phys_damage_dice="1d6", strength=4, charisma=6, wisdom=5,
        abilities=[
            Ability(
                name="Удар в сердце",
                description="Точный удар в уязвимое место: при попадании есть шанс мгновенно убить разумную цель",
    ...
    cat["lore_r_009"] = LoreEntry(
        ...
        when_to_apply="Квесты на севере, встреча с северянами, торговля с Хальмар",
    ...
    cat["lore_g_001"] = LoreEntry(
        ...
        category="МЕСТО",
        description="Грохания: в центре — провинция Грань со столицей Аника. Аника состоит из обычных кварталов и отдельного промышленного округа (тоже называемого Грань / Грани) с заводами и смогом. На севере — Вьюжные Пределы (столица Хальмар). На западе — Тенелесье (столица Сильванар). На юге — Пепельный Дозор (центральная крепость Чёрный Привал, в просторечии «Гарь»). На востоке — Непроходимый Предел (горы). Гетто Гро — внутри промышленного округа Аники.",
    ...
    cat["lore_g_002"] = LoreEntry(
        ...
        category="МЕСТО",
        description="Аника — столица Грохании. Сочетает два облика: основная часть города и окрестные земли — обычное средневековое фэнтези (увядающее барокко, мраморные шпили, дирижабли как редкая диковинка); отдельный промышленный округ (Грань) — паровые трубы, шестерни, смог. Богатые кварталы — на возвышенностях, вдали от промышленного смога. Гетто Гро — в промышленном округе, в грязи. Казна пуста, но парады идут.",
    ...
    cat["lore_g_003"] = LoreEntry(
        ...
        category="МЕСТО",
        description="Промышленный округ (Грань) — часть столицы Аника, индустриальное сердце империи: фабрики, заводы, шахты, мануфактуры. Смог, загрязнённые реки. Архитектура: угловатая, без плавных линий, паровые трубы и шестерни. За пределами округа — обычные фэнтезийные деревни, поля и малые города, экологически благополучные.",
    ...
    cat["lore_g_006"] = LoreEntry(
        ...
        category="МЕСТО",
        description="Вьюжные Пределы (Вьюга) — суровый север: тундра, тайга, ледники. Столица Хальмар — из чёрного камня. Северяне: кланы, вожди, шаманы. Полунезависимы — Великий Договор ~400 лет назад. Торгуют пушниной, древесиной, редкими минералами.",
    ...
    cat["lore_g_009"] = LoreEntry(
        ...
        category="МЕСТО",
        description="Пепельный Дозор (Пепел/Рубеж) — южная провинция. Не город с населением, а сеть фортов и застав вдоль границы с Пустыней Смерти. Центральная крепость — Чёрный Привал (в просторечии «Гарь»), построена из чёрного камня и пепла. 5-7 крупных крепостей, десятки малых застав. Сухо, ветрено, слабые пепельные бури.",
    ...
    cat["lore_a_001"] = LoreEntry(
        ...
        category="АТМОСФЕРА",
        description="Промышленный округ Грань (часть Аники): небо серое от смога, в воздухе запах угля и пара. Ночью небо светится от доменных печей. Паровые трубы повсюду. Дирижабли с имперскими флагами — редкость, вызывающая у простых жителей удивление и любопытство. Внизу — грязь и копоть гетто.",
    ...
    cat["lore_a_005"] = LoreEntry(
        ...
        category="АТМОСФЕРА",
        description="Хальмар: крепости из чёрного камня и деревянные дома с резными узорами, большие гостевые дома похожие на перевернутые корабли. Запах дыма из печей, оленьих шкур, хвои. Северяне в мехах и кожаных плащах с топорами. Шаман с посохом из костей. Олени запряжены в сани. Зимой — лыжи, пурга, снег до пояса.",
        when_to_apply="Сцены на севере, Хальмар, встречи с северянами",
    ...
    # ───────── лор-записи о правителях провинций ─────────
    cat["lore_pr_001"] = LoreEntry(
        lore_id="PR-001",
        name="Правители / Аника — Алест III",
        category="ПЕРСОНАЖ",
        description="Императора Грани зовут Алест III Добросердный. Прозвище отражает его настоящий характер: мягкий, добрый, искренне любящий семью человек, не правитель по натуре. Прототип образа — Николай II. Ведёт личный дневник с записями вроде «Чудесно поиграл с детьми. Подписал какие-то бумаги по Грани». Реальной властью почти не обладает — решения принимает Совет Анхари, он лишь подписывает.",
        when_to_apply="Сцены при дворе, характеристика императора, контраст между титулом и личностью",
        notes="Когда нужно проявить жёсткость — деревенеет, говорит чужими словами (явно не своими), потом мучается от этого. Про восстания в гетто узнаёт последним и искренне не понимает причин недовольства.",
    )
    cat["lore_pr_002"] = LoreEntry(
        lore_id="PR-002",
        name="Правители / Аника — Яна Корвус",
        category="ПЕРСОНАЖ",
        description="Императрица — Яна Корвус, дочь Префекта Гордия Корвуса (наместника Тенелесья). Выросла в Тенелесье, но леса не полюбила — возненавидела их как символ «дикарства». Фанатично верит в величие Анхари: технологии, чистота крови, восстановление империи на её исконных южных землях. Состоит в Совете Анхари не номинально, а как один из идеологов фракции — религиозный фанатик имперского толка.",
        when_to_apply="Сцены при дворе, политические интриги, мотивация похода/экспансии на юг",
        notes="Любовь к Алесту III искренняя, не наигранная и не расчётливая — для неё это не противоречит фанатизму. Алест не подозревает о её роли в Совете Анхари, видит лишь жену с «историческими увлечениями».",
    )
    cat["lore_pr_003"] = LoreEntry(
        lore_id="PR-003",
        name="Правители / Аника — интрига Аэлинн",
        category="НАРРАТИВ",
        description="Хранительница Тенелесья Аэлинн знает об устремлениях Яны и сознательно подогревает её веру в существование могущественных артефактов Анхари на юге. На деле там нет ничего, кроме смерти. Аэлинн рассчитывает, что одержимость Яны южным походом истощит и в конечном счёте погубит империю, расчищая путь к независимости Тенелесья.",
        when_to_apply="Сюжетные ходы про поход на юг, разоблачение интриги, финальные твисты",
        notes="Обе стороны — и Яна, и Аэлинн — уверены, что используют друг друга. На деле обе правы лишь отчасти: Яна не подозревает об истинной цели Аэлинн, Аэлинн недооценивает то, насколько глубоко фанатизм Яны укоренился независимо от её подсказок.",
    )
    cat["lore_pr_004"] = LoreEntry(
        lore_id="PR-004",
        name="Правители / Аника — дети",
        category="ПЕРСОНАЖ",
        description="У Алеста III и Яны трое детей: старшая дочь Кассандра, сын-наследник Николас, младшая дочь Флорентина. Все младше 10 лет, не посвящены ни в политику двора, ни в истинную роль матери.",
        when_to_apply="Сцены с императорской семьёй, потенциальные сюжетные крючки про наследование",
        notes="Дети — потенциальный рычаг давления со стороны Совета Анхари на Яну либо инструмент шантажа в будущих интригах.",
    )
    cat["lore_pr_005"] = LoreEntry(
        lore_id="PR-005",
        name="Правители / Хальмар — Бьярн",
        category="ПЕРСОНАЖ",
        description="Конунгом Вьюжных Пределов является Бьярн Серый Клык из клана Серых Клыков. Выбран советом кланов три года назад после смерти предыдущего конунга, не оставившего наследников. Крупный мужчина лет пятидесяти, шрамы, рыжая борода с сединой. Прагматик и хитрец, умеет изображать простака.",
        when_to_apply="Сцены на севере, переговоры с империей, характеристика конунга",
        notes="Знает, что империя гниёт изнутри, но деталей не знает и не стремится узнать — выжидает. Его реальная цель — чистая независимость севера, без имперского контроля над землями.",
    )
    cat["lore_pr_006"] = LoreEntry(
        lore_id="PR-006",
        name="Правители / Хальмар — политика Бьярна",
        category="ПОЛИТИКА",
        description="Власть Бьярна держится на балансе между кланами совета: одни хотят немедленной войны с империей, другие — углубления торговли и обогащения. Удерживание совета единым — его главная повседневная работа.",
        when_to_apply="Политические интриги севера, переговоры о войне или мире с империей",
        notes="—",
    )
    cat["lore_pr_007"] = LoreEntry(
        lore_id="PR-007",
        name="Правители / Хальмар — скелет в шкафу",
        category="НАРРАТИВ",
        description="Скелет в шкафу Бьярна — резня в Ветренном Пике. Клан Лютого Зверя во главе с Кольмом Бессердечным вырезал клан Снежных Сов, фактически контролировавший город: воины Кольма вошли под видом каравана торговцев, ночью перебили караул, впустили остальных бойцов и перерезали почти всех представителей клана Снежных Сов. Бьярн заранее знал о готовящемся ударе, не предупредил Снежных Сов и не санкционировал никаких ответных действий против Лютого Зверя.",
        when_to_apply="Раскрытие тёмного прошлого конунга, квесты о мести, моральные дилеммы севера",
        notes="Версии происходящего расходятся. Официальная: Бьярн боялся, что вмешательство развяжет полномасштабную межклановую войну, и выбрал меньшее зло. Неофициальная (слухи): клан Кольма в своё время поддержал восхождение Бьярна к власти конунга, и невмешательство было расплатой по старому долгу. Сам Бьярн никогда публично не объясняет своё бездействие.",
    )
    cat["lore_pr_008"] = LoreEntry(
        lore_id="PR-008",
        name="Правители / Хальмар — кровная вражда",
        category="УГРОЗА",
        description="Уцелевшие представители клана Снежных Сов немногочисленны и рассеяны, но знают правду о бездействии Бьярна и жаждут мести. Открытой войны не ведут — силы слишком неравны — но кровная вражда тлеет и не забыта.",
        when_to_apply="Сюжетные крючки, потенциальные союзники игроков против Бьярна, эскалация конфликта",
        notes="Достаточно одной искры — сильного союзника, ослабления Бьярна или смерти Кольма — чтобы вражда вспыхнула открыто.",
    )
    cat["lore_pr_009"] = LoreEntry(
        lore_id="PR-009",
        name="Правители / Хальмар — имперский наместник",
        category="ПЕРСОНАЖ",
        description="Имперский наместник в Хальмаре — Префект Гельмут Свельт, мелкий честолюбивый чиновник из Совета Анхари, присланный «следить» за севером. Реальной власти не имеет — Бьярн держит его в decorative положении, угощает на пирах, отвечает уклончиво. Свельт искренне считает себя тонким дипломатом и пишет в столицу донесения о «продуктивном диалоге», которым там охотно верят.",
        when_to_apply="Комические сцены при дворе конунга, контраст формальной и реальной власти",
        notes="—",
    )
    cat["lore_pr_010"] = LoreEntry(
        lore_id="PR-010",
        name="Правители / Тенелесье — Аэлинн",
        category="ПЕРСОНАЖ",
        description="Хранительница Тенелесья — Аэлинн из Серебряного Корня, пожилая полуэльфийка-друид. Избрана советом друидов двадцать лет назад, с тех пор переизбирается без оппозиции. Говорит медленно и веско. Помнит Великую Вырубку через друидскую практику памяти деревьев, а не лично.",
        when_to_apply="Сцены в Тенелесье, переговоры с империей, характеристика хранительницы",
        notes="Для большинства друидов и подданных выглядит терпеливой, мудро лавирующей защитницей леса. На деле — холодный стратег с конкретной политической целью.",
    )
    cat["lore_pr_011"] = LoreEntry(
        lore_id="PR-011",
        name="Правители / Тенелесье — цель Аэлинн",
        category="ПОЛИТИКА",
        description="Реальная цель Аэлинн — не абстрактная защита леса и не уничтожение империи как таковое, а полное отделение Тенелесья и создание независимого государства. Все её действия, включая манипуляцию через Яну и Гордия Корвуса, подчинены этой цели.",
        when_to_apply="Раскрытие истинных мотивов, финальные сюжетные арки про независимость Тенелесья",
        notes="—",
    )
    cat["lore_pr_012"] = LoreEntry(
        lore_id="PR-012",
        name="Правители / Тенелесье — совет друидов",
        category="ФРАКЦИЯ",
        description="Совет друидов формально единогласно поддерживает курс Аэлинн, но в реальности подавляющее большинство рядовых членов не знает истинной правды о её многоходовой игре через Яну и Совет Анхари. Они искренне верят, что Аэлинн просто мудро защищает лес дипломатическими средствами.",
        when_to_apply="Сцены внутри совета друидов, потенциальное разоблачение Аэлинн изнутри её же структуры",
        notes="Среди молодых друидов есть течение, симпатизирующее революционерам Гро — они хотят того же результата (конец империи), но через открытый союз и борьбу. Аэлинн тихо сдерживает их, не из несогласия с целью, а потому что преждевременное восстание разрушит её долгую игру.",
    )
    cat["lore_pr_013"] = LoreEntry(
        lore_id="PR-013",
        name="Правители / Тенелесье — Гордий Корвус",
        category="ПЕРСОНАЖ",
        description="Имперский наместник в Тенелесье — Префект Гордий Корвус, отец императрицы Яны. Искренне считает себя умелым дипломатом, «выстроившим отношения с местными», и гордится дочерью-императрицей. Не подозревает, что десятилетиями является лишь первым звеном в цепочке манипуляции Аэлинн (Корвус → Яна → Алест III).",
        when_to_apply="Комические и трагические сцены с наместником, разоблачение цепочки манипуляций",
        notes="—",
    )
    cat["lore_pr_014"] = LoreEntry(
        lore_id="PR-014",
        name="Правители / Пепельный Дозор — устройство",
        category="МЕСТО",
        description="Пепельный Дозор — не провинция с городами, а сеть аванпостов, фортов и крепостей вдоль дорог, идущих от столицы вглубь пепельных земель. Гражданского населения в привычном смысле нет: пепельные бури делают земледелие невозможным, дичь скудна. Всё держится на снабжении извне.",
        when_to_apply="Описания Пепельного Дозора, путешествия через регион",
        notes="Население делится на три группы: гарнизоны (солдаты, чаще отправленные служить не в награду), транзитные (торговцы, наёмники, беглые преступники), и жители центральной крепости Чёрный Привал.",
    )
    cat["lore_pr_015"] = LoreEntry(
        lore_id="PR-015",
        name="Правители / Пепельный Дозор — Чёрный Привал",
        category="МЕСТО",
        description="Чёрный Привал — единственная крупная крепость региона с настоящим гражданским укладом: инженеры, кузнецы и прочие мастеровые, частью присланные сюда по распределению с семьями, частью сосланные. Здесь есть рынок, таверны, рождаются дети — остров нормальности посреди пепла.",
        when_to_apply="Сцены городской жизни Пепельного Дозора, контраст с остальной мёртвой землёй",
        notes="—",
    )
    cat["lore_pr_016"] = LoreEntry(
        lore_id="PR-016",
        name="Правители / Пепельный Дозор — комендант",
        category="ПЕРСОНАЖ",
        description="Правит Пепельным Дозором из Чёрного Привала Комендант Кадан Толбин, бывший военный инженер. Назначен пятнадцать лет назад. Циник высшей пробы: знает, что заставы по факту используются для отмывания денег и как место ссылки неугодных. Держит порядок не из идеализма, а из упрямства — альтернативу хаосу он уже видел.",
        when_to_apply="Сцены в Чёрном Привале, характеристика коменданта, контраст с придворными правителями",
        notes="Толбин краем уха слышал, что Дозор существует не просто так — что Вечный Ужас может быть не просто легендой. Сам он ещё не решил, верит ли в это всерьёз; вопрос остаётся открытым и для лора в целом.",
    )
    cat["lore_pr_017"] = LoreEntry(
        lore_id="PR-017",
        name="Правители / Механизм передачи власти",
        category="ПОЛИТИКА",
        description="Механизм передачи власти различается по провинциям. В Анике императора утверждает Совет Анхари (формально — наследование, но фактически воля Совета); нынешний Алест III занял трон после того, как прошлый император был убит и не оставил наследников. В Тенелесье хранителя избирает совет друидов. На севере (Хальмар) совет кланов выбирает титульный клан, лидер которого становится конунгом всего севера.",
        when_to_apply="Сцены престолонаследия, объяснение легитимности власти, политические интриги",
        notes="В Тенелесье и на севере формально есть имперские наместники, и по документам они должны стоять выше местных правителей. На деле они почти ничего не контролируют — реальная власть полностью в руках Хранительницы и конунга.",
    )
    cat["lore_pr_019"] = LoreEntry(
        lore_id="PR-019",
        name="География / Топонимы Пепельного Дозора",
        category="МЕСТО",
        description="Центральная крепость Пепельного Дозора официально называется Чёрный Привал. В неформальной речи — у солдат, торговцев, ссыльных — крепость почти всегда называют просто Гарь.",
        when_to_apply="Диалоги жителей и солдат Пепельного Дозора, бытовая речь, контраст официального и разговорного языка",
        notes="Официальные документы, имперская переписка и наместники используют «Чёрный Привал»; в разговорной речи, особенно среди гарнизона и местных, закрепилось короткое «Гарь».",
    )
