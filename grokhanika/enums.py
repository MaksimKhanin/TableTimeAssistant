...
class EffectTarget(str, Enum):
    ...
    BASTION = "bastion"
    # маркер-состояние: атакующий игнорирует Бастион (самонаводящиеся атаки) и
    # может выбрать одиночной целью кого угодно, даже если у врага жив «бастион».
    IGNORE_BASTION = "ignore_bastion"
